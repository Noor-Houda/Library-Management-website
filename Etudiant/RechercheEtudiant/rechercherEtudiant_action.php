...
$champ=$_POST['options']; 
$valeur=$_POST['valeur']; 
$requet="select * from etudiant where $champ like '$valeur' "; 
...
<body>
    ...
    <img src='http://localhost/TP5 web_dev/Photos/decline.png'/>
        <h2>Etudiant non trouvé<h2>
            <br>
        <a href='rechercheEtudiant.php'><button>Retour</button></a>
    </div>
    </div>
</body> </html>"; 
...
<body>
    ...
    <img src='http://localhost/TP5 web_dev/Photos/mark.png'/>
        <h2>L'étudiant rechercher existe dans la base<h2>
            <br>
        <a href='rechercheEtudiant.php'><button>Retour</button></a>
    </div>
    </div>
